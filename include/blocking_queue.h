...
//class BlockingQueue {
//private:
//    int capacity, frontIdx, rearIdx, size;
//    T *queue;
//    std::shared_mutex mutex;
//    std::condition_variable_any cond;
//    BlockingQueue<T> *twin;
//
//    bool isEmpty();
//
//    bool isFull();
...
//public:
//
//    explicit BlockingQueue(int _capacity);
//
//    int getSize() {
//        return size;
//    }
...
//    long long int clear();
//
//    int clearWith(std::function<void(T)> func);
//
//    void notify();
//
//};
...
//        int _capacity): capacity(_capacity), frontIdx(-1), rearIdx(-1), size(0), twin(this) {
...
//
//template<typename T>
//int BlockingQueue<T>::clearWith(std::function<void(T)> func) {
//    std::unique_lock<std::shared_mutex> exLock(mutex);
//    int ret = size;
